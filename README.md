...
- **Phase 1 (M0 ✓)**: Nền tảng — modular monolith, catalog, order, inventory, web, admin, CI/CD
- **Phase 2**: Auth JWT + OTP, thanh toán VNPay/MoMo sandbox, quiz tư vấn nội thất, đánh giá, Elasticsearch
